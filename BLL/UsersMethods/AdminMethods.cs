...
namespace BLL.UsersMethods
{
    ...
    {
        Admin user;
        internal Manager CreateManager(int id, string name, string surname, string patronymic, string email, string password)
        {
            Manager manager = new Manager(id, name, surname, patronymic, email, password);
